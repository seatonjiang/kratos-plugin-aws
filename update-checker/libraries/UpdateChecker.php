...
if (!class_exists(UpdateChecker::class, false)):
    ...
    abstract class UpdateChecker
    {
        ...
        public function checkForUpdates()
        {
            ...
            add_action('api_error', array($this, 'collectApiErrors'), 10, 4);
            ...
            remove_action('api_error', array($this, 'collectApiErrors'), 10);
         ...
         *
         * This method adds the "" prefix and the "-$slug" suffix to the filter name.
         * For example, "pre_inject_update" becomes "pre_inject_update-plugin-slug".
         *
         ...
         *
         * Identical to add_filter(), except it automatically adds the "" prefix
         * and the "-$slug" suffix to the filter name. For example, "request_info_result"
         * becomes "request_info_result-your_plugin_slug".
         *
         * @param string $tag
        ...
        protected function requestMetadata($metaClass, $filterRoot, $queryArgs = array())
        {
            ...
            if (!is_wp_error($status)) {
                ...
                do_action('api_error', $status, $result, $url, $this->slug);
                $this->triggerError(
        ...
        protected function validateApiResponse($result)
        {
            ...
            if (empty($result['body'])) {
                return new WP_Error('empty_response', 'The metadata file appears to be empty.');
            }
