...
use KratosUpdateChecker\InstalledPackage;
use KratosUpdateChecker\UpdateChecker as BaseUpdateChecker;
use KratosUpdateChecker\Scheduler;
use KratosUpdateChecker\DebugBar;
...
if (!class_exists(UpdateChecker::class, false)):
    ...
    class UpdateChecker extends BaseUpdateChecker
    {
        ...
        public function __construct($metadataUrl, $pluginFile, $slug = '', $checkPeriod = 12, $optionName = '', $muPluginFile = '')
        {
            ...
            $slugCheckFilter = 'is_slug_in_use-' . $slug;
