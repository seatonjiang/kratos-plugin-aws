...
namespace KratosUpdateChecker\Plugin;
...
if (!class_exists(Ui::class, false)):
    ...
    class Ui
    {
         ...
         *
         * You can change the link text by using the "view_details_link-$slug" filter.
         * Returning an empty string from the filter will disable the link.
         *
         * You can change the position of the link using the
         * "view_details_link_position-$slug" filter.
         ...
         *
         * You can change the link text by using the "manual_check_link-$slug" filter.
         * Returning an empty string from the filter will disable the link.
         *
         * @param array $pluginMeta Array of meta links.
         * @param string $pluginFile
        ...
        {
            $shouldCheck =
                isset($_GET['check_for_updates'], $_GET['slug'])
                && $_GET['slug'] == $this->updateChecker->slug
         ...
         *
         * You can change the result message by using the "manual_check_message-$slug" filter.
         */
        public function displayManualCheckResult()
        {
            //phpcs:disable WordPress.Security.NonceVerification.Recommended -- Just displaying a message.
            if (isset($_GET['update_check_result'], $_GET['slug']) && ($_GET['slug'] == $this->updateChecker->slug)) {
                $status = sanitize_key($_GET['update_check_result']);
