...
use KratosUpdateChecker\Factory;
...
if (!class_exists(Extension::class, false)):
    ...
    class Extension
    {
        ...
        public function __construct($updateChecker, $panelClass = null)
        {
            ...
            add_action('wp_ajax_v5_debug_check_now', array($this, 'ajaxCheckNow'));
        }
        ...
        public function enqueuePanelDependencies()
        {
            wp_enqueue_style(
                'debug-bar-style-v5',
                $this->getLibraryUrl("/css/debug-bar.css"),
                array('debug-bar'),
                '20221008'
            );
        ...
        public function removeHooks()
        {
            ...
            remove_action('wp_ajax_v5_debug_check_now', array($this, 'ajaxCheckNow'));
        }
